...
- **You are on Laravel 10 or older, or your app standardizes on a DTO/validation layer other than `spatie/laravel-data` v4:** the generated output is laravel-data classes targeting Laravel 11/12/13, so it would not fit your stack.
