...
It never inspects your concrete controllers (hand-written or scaffolded once with [`openapi:scaffold`](/guides/server-scaffold#concrete-controller-stubs-openapiscaffold)) or any unrelated file. A file is reported as drifted when it is either:
...
See [Unsupported constructs report](/guides/unsupported-report) for the file shape, the list of recorded constructs, and how to opt out.
