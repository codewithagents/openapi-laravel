...
import type { ApiResponse, Order, Pet, PetWritable, User } from "./models.js";
...
function _buildSignal(
  ...
  if (typeof AbortSignal.any === "function")
    return AbortSignal.any([signal, _ts]);
...
async function _request(
  ...
  if (_resolvedSignal !== undefined)
    _init = { ..._init, signal: _resolvedSignal };
...
export async function loginUser(
  ...
  if (params?.password != null)
    searchParams.set("password", String(params.password));
